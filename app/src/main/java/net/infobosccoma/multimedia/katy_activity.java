...
public class katy_activity extends ActionBarActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_katy_activity);
        ...
        userInfo= (User)getIntent().getExtras().getSerializable("user");
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        if (!mNavigationDrawerFragment.isDrawerOpen()) {
            ...
            getMenuInflater().inflate(R.menu.katy_activity, menu);
            restoreActionBar();
            return true;
        }
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.fragment_katy_activity, container, false);
            return rootView;
        }
        ...
        public void onAttach(Activity activity) {
            ...
            ((katy_activity) activity).onSectionAttached(
